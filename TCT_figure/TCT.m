%unshading
fig1 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\unshading.fig','reuse');
...
% uneven_column
fig2 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\uneven_column.fig','reuse');
...
%uneven_row
fig3 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\uneven_row.fig','reuse');
...
%short_narrow
fig4 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\short_narrow.fig','reuse');
...
%short_wide
fig5 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\short_wide.fig','reuse');
...
%long_narrow
fig6 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\long_narrow.fig','reuse');
...
%long_wide
fig7 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\long_wide.fig','reuse');
...
%diagonal
fig8 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\diagonal.fig','reuse');
...
%random
fig9 = openfig('F:\阅读笔记\论文仿真图\TCT_figure\random.fig','reuse');
