%unshading
fig1 = openfig('F:\阅读笔记\论文仿真图\SP_figure\unshading.fig','reuse');
...
% uneven_column
fig2 = openfig('F:\阅读笔记\论文仿真图\SP_figure\uneven_column.fig','reuse');
...
%uneven_row
fig3 = openfig('F:\阅读笔记\论文仿真图\SP_figure\uneven_row.fig','reuse');
...
%short_narrow
fig4 = openfig('F:\阅读笔记\论文仿真图\SP_figure\short_narrow.fig','reuse');
...
%short_wide
fig5 = openfig('F:\阅读笔记\论文仿真图\SP_figure\short_wide.fig','reuse');
...
%diagonal
fig8 = openfig('F:\阅读笔记\论文仿真图\SP_figure\diagonal.fig','reuse');
...
%random
fig9 = openfig('F:\阅读笔记\论文仿真图\SP_figure\random.fig','reuse');
...
title('I-V & I-P');
subplot(2,1,1);
plot(xc1_1,yc1_1,'color',[1 0 0],'LineWidth',1.3);
hold on ;
plot(xc2_1,yc2_1,'color',[0 0 1],'LineWidth',1.3);
plot(xc3_1,yc3_1,'color',[0 0.5 0.3],'LineWidth',1.3);
plot(xc4_1,yc4_1,'g','LineWidth',1.3);
plot(xc5_1,yc5_1,'color',[1 1 0],'LineWidth',1.3);
plot(xc6_1,yc6_1,'color',[1 0 1],'LineWidth',1.3);
plot(xc7_1,yc7_1,'color',[0 1 1],'LineWidth',1.3);
plot(xc8_1,yc8_1,'color',[0.67 0 1],'LineWidth',1.3);
plot(xc9_1,yc9_1,'color',[1 0.5 0],'LineWidth',1.3);
axis([0 70 0 55]);
...
subplot(2,1,2);
plot(xc1_2,yc1_2,'color',[1 0 0],'LineWidth',1.3);
...
hold on;
plot(xc2_2,yc2_2,'color',[0 0 1],'LineWidth',1.3);
text(xc2_2(p2),yc2_2(p2),'o');
plot(xc3_2,yc3_2,'color',[0 0.5 0.3],'LineWidth',1.3);
text(xc3_2(p3),yc3_2(p3),'o');
plot(xc4_2,yc4_2,'g','LineWidth',1.3);
text(xc4_2(p4),yc4_2(p4),'o');
plot(xc5_2,yc5_2,'color',[1 1 0],'LineWidth',1.3);
text(xc5_2(p5),yc5_2(p5),'o');
plot(xc6_2,yc6_2,'color',[1 0 1],'LineWidth',1.3);
text(xc6_2(p6),yc6_2(p6),'o');
plot(xc7_2,yc7_2,'color',[0 1 1],'LineWidth',1.3);
text(xc7_2(p7),yc7_2(p7),'o');
plot(xc8_2,yc8_2,'color',[0.67 0 1],'LineWidth',1.3);
text(xc8_2(p8),yc8_2(p8),'o');
plot(xc9_2,yc9_2,'color',[1 0.5 0],'LineWidth',1.3);
text(xc9_2(p9),yc9_2(p9),'o');
axis([0 70 0 2400]);
legend_FontSize=legend('Uniform','Column shading','Row shading','Short and narrow','Short and wide','Long and narrow','Long and wide','Diagonal shading','Random shading');
